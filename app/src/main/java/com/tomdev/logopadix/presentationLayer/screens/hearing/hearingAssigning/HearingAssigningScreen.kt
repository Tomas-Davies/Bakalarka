...
class HearingAssigningScreen: AppCompatActivity() {
        ...
        setContent {
            AppTheme(ThemeType.THEME_HEARING.id) {
                Surface(
                    ...
                    ScreenWrapper(
                        title = stringResource(R.string.hearing_menu_label_4),
                        onExit = { finish() }
                    ) {
                        HearingAssignScreenContent(viewModel)
                    }
                }
            }
        }
    ...
    @Composable
    private fun HearingAssignScreenContent(viewModel: HearingAssignViewModel) {
        ScreenWrapper(
            onExit = { finish() },
            ...
            AsyncDataWrapper(viewModel = viewModel) {
                Column(
                    ...
                    HearingAssignRunning(viewModel = viewModel)
                }
            }
        }
    }
    ...
    @Composable
    private fun HearingAssignRunning(viewModel: HearingAssignViewModel) {
        ...
        RoundsCompletedBox(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = R.string.hearing_assign_label),
                ...
                val soundName = uiState.chosenObject.soundName ?: ""
